...
class ConditionTest {
    ...
    @TestFactory
    fun testFromWmoCodeAndIsDay() = listOf(
        ...
        DynamicTest.dynamicTest("fromWmoCodeAndIsDay($input) should return $expected") {
            val actual = Condition.fromWmoCodeAndIsDay(input.first, input.second)
